...
accept_key = mouse_check_button_pressed(mb_left) && active && (obj_menu.hover_pos == noone) && (obj_menu.option_pos < 0); // Only try to advance dialogue if we are in the game state.
skip_key = mouse_check_button_pressed(mb_right) && active;
